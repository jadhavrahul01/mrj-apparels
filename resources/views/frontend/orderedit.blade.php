    ...
    <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="/order-update/{{ $order->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">CUSTOMER NAME</label>
                                        <input type="text" class="form-control" name="cname" value="{{ $order->cname }}" readonly>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">CUSTOMER ADD</label>
                                        <input type="text" class="form-control" name="cadd" value="{{ $order->cadd }}" readonly>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">CUSTOMER GSTIN</label>
                                        <input type="text" class="form-control" name="cgstin" value="{{ $order->cgstin }}" readonly>
                                    </div>

                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">STYLE REF</label>
                                        <input type="text" class="form-control" name="styleref" value="{{ $order->cstyle_ref }}" {{ Auth::user()->role == 2 ? '' : 'disabled' }}>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label class="form-label">PO NUMBER</label>
                                        <input type="text" class="form-control" name="pono" value="{{ $order->ponumber }}" required>
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="col-md-12 d-flex justify-content-center align-items-center">
                                            @if ($order->poimg)
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" value="{{ $order->poimg }}" name="oldpoimg" disabled>
                                            </div>
                                            @endif
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="col-md-9">
                                                <input type="email" class="mt-1 form-control" placeholder="Enter Email Id 1" name="email1" value="{{ $order->email }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Enter Phone Number 1" name="phone1" value="{{ $order->phone }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-6 mt-4">
                                        ...
                                        <div id="inputContainer2">
                                            ...
                                            <div class="d-flex align-items-center input-container2 mb-3">
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" placeholder="Enter Measurement Taker Name 1" name="mtaker[]" id="mtaker{{ $index }}" value="{{ $mtaker['mtaker'] }}" required {{ $mtaker['mtaker'] ? 'readonly' : '' }}>
                                                </div>
                                                <div class="col-md-3 ms-3">
                                                    <input type="date" class="form-control" name="mdatetime[]" id="mdatetime{{ $index }}" value="{{ $mtaker['mtaker_date'] }}" required {{ $mtaker['mtaker_date'] ? 'readonly' : '' }}>
                                                </div>
                                                <div class="col-md-1 ms-5">
                                                    <button type="button" class="btn btn-sm btn-danger remove-button2">Remove</button>
                                                </div>
                                            </div>
                                            @endforeach
                                            <div class="col-md-3 ms-5">
                                                <button id="addInput2" type="button" class="btn btn-primary" style="width: 200px; padding: 5px 10px; font-size: 12px;">Add
                                                    Measurement</button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                    ...
                    <div class="mb-3 table-search pe-3">
                        <form action="" method="get">
                            <div class="input-group search-area">
                                <input type="text" name="s" class="form-control" placeholder="Search customer name here" value="{{ Request::get('s') }}" required>
                ...
                <div class="excelbtn">
                    <a href="{{ route('empdetails.export', ['customerId' => $order->u_id]) }}" class="btn btn-primary me-4">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('invoice.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="od_id" id="od_id" class="form-control" readonly>
                            <ul id="errstatus"></ul>
                        </div>
            ...
            <div class="table-responsive fs-14">
                <table class="table mb-4 display dataTablesCard order-table shadow-hover card-table" id="example5">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            @if ($order->fabrics_status == 2)
                            <td><input type="checkbox" class="recordCheckbox" name="ids[]" value="{{ $od->id }}"></td>
                            @endif
                            ...
                            <td>
                                @if ($od->status == 'D')
                                <a href="{{ route('download', $od->id) }}" class="btn btn-primary">
                                    Download
                                </a>
                                @else
                                <div class="dropdown ms-auto c-pointer">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @if ($order->fabrics_status == 2)
                                        <form action="/m-done/{{ $od->id }}/{{ $order->id }}" method="POST">
                                            @csrf
                                        ...
                                        <form action="/ready-dispatch/{{ $od->id }}" method="POST">
                                            @csrf
                                            <button type="submit" class="text-black dropdown-item">
                                                Ready for dispatch
                                            </button>
                                        ...
                                        @if ($od->status == 'RD')
                                        {{-- <form action="/emp_dispatch/{{ $od->id }}" method="POST"> --}}
                                        {{-- @csrf --}}
                                        <button type="button" data-toggle="modal" data-target="#eModal" data-odid="{{$od->id}}" class="text-black dropdown-item">
                                            Dispatched
                                        </button>
                                        {{-- </form> --}}
                                        @endif
...
<script>
    ...
    $('#eModal').on('show.bs.modal', function(event) {
        ...
        var odid = button.data('odid')
        var modal = $(this)
        modal.find('#od_id').val(odid)
    })

    $(document).ready(function() {
        $('.form-inline').on('submit', function(e) {
            if ($('select[name="status"]').val() == 'D') {
                e.preventDefault();
